...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Felipe Guimarães", "", "felypeguima@yahoo.com.br");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("ZX-Ventures Challenge", "Back-end API - Serviços específicos para PDV (Ponto de Venda): criar, buscar por ID e buscar por lng e lat.", "1.0",
